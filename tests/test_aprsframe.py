...
class FrameTestCase(aprs_test_classes.APRSTestClass):  # pylint: disable=R0904
    ...
    def test_aprs_frame(self):
        ...
        formatted_frame = aprs.Frame.parse(frame)
    ...
    def test_ax25_encode(self):
        ...
        self.assertEqual(str(aprs.Callsign.from_ax25(encoded_frame[1:8])), 'APRX24')
        self.assertEqual(str(aprs.Callsign.from_ax25(encoded_frame[8:15])), 'W2GMD-6')
        self.assertEqual(str(aprs.Callsign.from_ax25(encoded_frame[15:22])), 'WIDE1-1')
        self.assertEqual(str(aprs.Callsign.from_ax25(encoded_frame[22:29])), 'WIDE2-1')
        ...
        decoded_frame = aprs.Frame.parse(encoded_frame)
